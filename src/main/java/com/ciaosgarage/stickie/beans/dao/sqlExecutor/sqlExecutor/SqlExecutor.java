...
public interface SqlExecutor {
     ...
     * @return 조건에 맞는 레코드
     */
    ValueObject queryForObject(Class voInfo, String sql, Map<String, Object> parameters);
     ...
     * @return 조건에 맞는 레코드
     */
    List<ValueObject> query(Class voInfo, String sql, Map<String, Object> parameters);

    /**
     * 해당 테이블의 전체 레코드의 수를 가져오는 메소드
     *
     * @param tablename 검색할 테이블의 이름
