...
public class MysqlResultSetTranslator implements ResultSetTranslator {
    ...
    @Override
    public ValueObject translator(ResultSet resultSet, Class voInfo) throws SQLException {

        // ValueObject 객체 생성
        ValueObject newVo = getNewVo(voInfo);
    ...
    private ValueObject getNewVo(Class voInfo) throws SQLException {
        try {
            ValueObject newVo = (ValueObject) voInfo.newInstance();
            return newVo;
    ...
    private ValueObject insertData(ValueObject newVo, String dataType, String rcdName, ResultSet resultSet) throws SQLException {
